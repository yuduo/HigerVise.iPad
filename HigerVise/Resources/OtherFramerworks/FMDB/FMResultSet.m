...
- (NSDate*)dateForColumnIndex:(int)columnIdx {
    ...
    NSString *stringValue = [self stringForColumnIndex:columnIdx];
    if ([stringValue rangeOfString:@"-"].length > 0 && [stringValue rangeOfString:@":"].length > 0) {
    ...
    else if ([stringValue rangeOfString:@"/"].length > 0 && [stringValue rangeOfString:@":"].length > 0) {
        NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
        NSTimeZone *timeZone = [NSTimeZone localTimeZone];
        [dateFormatter setTimeZone:timeZone];
        [dateFormatter setDateFormat:@"yyyy/MM/dd HH:mm:ss"];  
